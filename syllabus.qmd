...
Lab assignments are designed to expand your statistical knowledge. These will be completed in Google Colab which can be accessed from Canvas. There is one lab every week that you can be completed during class time. The lab assignment will be due on Wednesday at 11:59 PM every week.
...
Book practice problems are designed to give you extra practice to learn the statistical concepts. While these problems are not required for the course. It is highly recommend that you attempt the material to master the course.
...
| Week        | Topic                                   | Readings   | Lab Due | Video Lecture Due |
|:--------------|:--------------|:--------------|:--------------|---------------|
