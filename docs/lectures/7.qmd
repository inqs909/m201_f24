...
The odds of observing the first category ($Y = 1$) in the idicated category ($D=1$) is .
...
::: fragment
As age increases by 1 year, the odds of experiencing death increases by a factor of 1.004, adjusting gender, tumor thickness and presence of an ulcer.
:::
