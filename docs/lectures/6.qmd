...
Computing $R^2$ is done by determine how much the variation in the outcome is explained by model and divided by the variation of the outcome.
...
Problems arise when multiple predictors are added model. As a new predictor is added to the model, new information is added to the model which will always reduce the variation in the residuals. Therefore, the $R^2$ will always increase.
...
9% of the variation in danceability is explained by the model.
